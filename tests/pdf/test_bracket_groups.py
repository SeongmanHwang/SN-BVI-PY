...
def _draw_bracket(
    ...
    *,
    ...
    """위·아래 세로선 + 왼쪽 턱 (가운데 끊김)."""
    page.draw_line(fitz.Point(stem_x - tick, y0), fitz.Point(stem_x, y0), width=0.8)
    ...
    page.draw_line(fitz.Point(stem_x - tick, y1), fitz.Point(stem_x, y1), width=0.8)

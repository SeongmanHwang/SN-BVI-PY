...
| [extraction_and_translation.md](extraction_and_translation.md) | PDF 추출 요약·예외, 점역 처리 순서·예외 분류 |
| [ui_shell.md](ui_shell.md) | 제품 모드(웹 사용자·개발자 A/B), 세션 경계·a11y·체크리스트 |
| [reverse_translation.md](reverse_translation.md) | 역점역 모듈 구조·처리 순서·함정·시험지 토큰·테스트 |
